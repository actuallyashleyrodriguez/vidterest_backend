...
art1 = Video.create(title: "Spin Art" , description: "Color Shifting Spin Art", video_url: "https://www.tiktok.com/oembed?url=https://www.tiktok.com/@johnnyqqq/video/6945609521884581126", category_id: art.id)
art2 = Video.create(title: "Tie Dying" , description: "Geode Tie Dye shirts", video_url: "https://www.tiktok.com/oembed?url=https://www.tiktok.com/@corkylorenz/video/6949344578168212742", category_id: art.id)
funny1 = Video.create(title: "Spiderman Prank" , description: "Interview Prank on Tom Holland", video_url: "https://www.tiktok.com/oembed?url=https://www.tiktok.com/@lu.brm/video/6948126065692904710", category_id: funny.id)
funny2 = Video.create(title: "March 31st" , description: "April thought March 31st wasn't a real date", video_url: "https://www.tiktok.com/oembed?url=https://www.tiktok.com/@aprilludgcte/video/6945610254826753282", category_id: funny.id)
